...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO ThuThu VALUES('admin','Admin','admin')," +
                "('duc','Ha Dang Duc','123')");
        db.execSQL("INSERT INTO ThanhVien VALUES(1,'Nguyen Van A','2000','123')," +
                "(2,'PNguyen Van B','2001','456')");
        ...
        db.execSQL("INSERT INTO PhieuMuon VALUES(1,'admin','1','1','2000','2024/05/21','1')," +
                "(2,'duchd','2','2','2003','2025/05/23','1')");
    }
